...
const LandingIndex = ({}: ILandingIndex) => {
  ...
  return (
    <>
      <Section hasImage>
        <Grid dontCenter numberOfColumns={2}>
          <div>
            ...
            <StreamingPlatforms isHeroComponent />
          </div>
          <div className='relative'>
            <Image
              additionalClass='transform -translate-y-28 -translate-x-16 w-full h-full'
              width='w-[1100px]'
      ...
      <Section additionalClass='transform -translate-y-40' noPadding>
        <Grid additionalClass='place-items-center' numberOfColumns={2}>
          <Image
            ...
            imageSource={RecommendationsImage}
          />
      ...
      <Section>
        <Grid
          additionalClass='max-w-[50rem] mx-auto place-items-center text-center px-[60px] mb-[5rem]'
          numberOfColumns={1}
        >
          <Image
            width='w-[56px]'
            alt='Just watch logo'
            imageSource={JustWatchLogo}
          />
