...
const StreamingPlatforms = ({}: IStreamingPlatforms) => {
      ...
      <>
         ...
         <div className="flex items-center">
             <div className="flex items-center space-x-2.5">
                 {streamingPlatforms.map((streamingPlatform)=> <PlatformIcon key={streamingPlatform.id} platform={streamingPlatform}/>)}
             </div>
             <div className="text-white pl-[20px] cursor-pointer text-primary text-[12px] hover:text-linkhover">I MNOGO VIŠE</div>
         </div>
      </>
  );
};
